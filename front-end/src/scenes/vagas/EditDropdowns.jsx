...
export const CoordenadorDropdown = ({ value, onChange, error }) => {
  ...
  return (
    <FormControl fullWidth error={error}>
      ...
      <Select value={value} label="Coordenador" onChange={onChange}>
...
export const TipoTarefaDropdown = ({ value, onChange, error }) => {
  ...
  return (
    <FormControl fullWidth error={error}>
      ...
      <Select value={value} label="Tipo de Tarefa" onChange={onChange}>
...
export const StatusVagaDropdown = ({ value, onChange, error }) => {
  ...
  return (
    <FormControl fullWidth error={error}>
      ...
      <Select value={value} label="Status da Vaga" onChange={onChange}>
